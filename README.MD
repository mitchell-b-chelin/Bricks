<p align="center">
    <img alt="WPBricks" src="./inc/docs/_images/WPBricks.png">
</p>

<div align="center">
<h2>Bricks.</h2>
<h3>A developer friendly guttenberg block registration method.</h3>
</div>
...
**Note:** we can change this base directory naming later on [Overides](#overides).

# Building Bricks
If you have created your brick folder path from [Setup](#setup) your halfway there.
...
icon.svg
```
**Note:** a SVG icon is located with one of these filenames it will replace the icon set in the block JSON.
